"""
This file contains the dataloader for cardiac dataset
"""
...
class SliceData_cardiac(Dataset):
    def __init__(self, root, samplingMode, isTrain=0):
        ...
        print("Generate Cardiac dataset ... ")
        for i in tqdm(iRange): # for each patient
            for z in range(0,5): #0,4 # for each slice
                for t in tList: #1,20 # for each time
                    filename = 'mr_heart_p%02dt%02dz%d.png' %(i, t, z)
